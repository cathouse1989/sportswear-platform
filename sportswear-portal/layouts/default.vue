          ...
          <div>
            ...
            <ul class="space-y-3 text-sm text-[#9A8C7A]">
              <li class="flex items-center gap-3">
                ...
                <a :href="contactEmailHref" class="hover:text-white">{{ $t('contact.email_value') }}</a>
              </li>
              <li class="flex items-center gap-3">
                ...
                <a :href="contactPhoneHref" class="hover:text-white">{{ $t('contact.phone_value') }}</a>
              </li>
              <li class="flex items-center gap-3">
              ...
              <li class="flex items-center gap-3">
                <svg class="w-4 h-4 flex-shrink-0 text-[#D4A853]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
...
// 联系方式链接（显示文案走 $t('contact.*_value') 多语言词条，可由后台「主题配置 → 联系方式」维护）
