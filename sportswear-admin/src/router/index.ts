...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'about', name: 'About', component: () => import('@/views/cms/about.vue'), meta: { title: '关于我们', permission: 'page:view' } },
      ...
      { path: 'portal-health', name: 'PortalHealth', component: () => import('@/views/system/health.vue'), meta: { title: '门户健康检查', permission: ['navigation:manage', 'seo:manage', 'page:view'] } },
